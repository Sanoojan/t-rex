...
class SimplifiedLoader():
    def __init__(self, set_name) -> None:
        self.aircraftsdata_path = "/l/users/sanoojan.baliah/dataset/fgvc-aircraft-2013b/"
        self.foodxdata_path =  "/l/users/sanoojan.baliah/dataset/FoodX/food_dataset/"
        self.carsdata_path =  "/l/users/sanoojan.baliah/dataset/stanford_cars/"
    ...
    def _fetch_dataset(self, set_name, type_, augument):

        infer_flag = False
        if type_ in ['valid', 'test', 'infer']:
            infer_flag = True

        if augument == "DEFAULT" or infer_flag:
        ...
        if set_name == "air":
           ...
           dataset = FoodXDataset(data_dir=self.foodxdata_path, 
            ...
            air_dataset = FGVCAircraft(data_dir=self.aircraftsdata_path, mode=type_,
                            transform=data_transform)
            car_dataset = StanfordCars(data_dir=self.carsdata_path, mode=type_,
...
if __name__ == "__main__":
    ...
    aircraftsdata_path = "/l/users/sanoojan.baliah/dataset/fgvc-aircraft-2013b/"
    foodxdata_path =  "/l/users/sanoojan.baliah/dataset/FoodX/food_dataset/"
    carsdata_path =  "/l/users/sanoojan.baliah/dataset/stanford_cars/"
